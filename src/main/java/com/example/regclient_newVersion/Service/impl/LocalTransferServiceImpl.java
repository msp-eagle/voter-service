...
import com.example.regclient_newVersion.Service.PrimaryClearService;
import com.example.regclient_newVersion.Service.SecondaryClearService;
...
//    private String localApplicantsPassword;
    ...
    private final PrimaryClearService primaryClearService;
    private final SecondaryClearService secondaryClearService;

    @Autowired
    public LocalTransferServiceImpl(
            PrimaryClearService primaryClearService,
            SecondaryClearService secondaryClearService) {

        this.primaryClearService = primaryClearService;
        this.secondaryClearService = secondaryClearService;
    }
...
//    }
    ...
    public TransferResponseDTO clearAllLocalTableData() {

        try {

            primaryClearService.clearData();
            secondaryClearService.clearData();

            return new TransferResponseDTO(
                    "SUCCESS",
                    "Primary DB: 2 tables cleared. " +
                            "Secondary DB: 5 tables cleared.",
                    0
            );
